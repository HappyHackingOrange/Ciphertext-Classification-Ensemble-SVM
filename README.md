...
## Data
Ten datasets of 5,000 ciphertext messages each (1,000 each of the following classic ciphers), each dataset with varying ciphertext lengths ranging from 100 to 1000 at increment of 100, were generated:
...
4. Select the cipher type with the maximum probability to be the chosen cipher type for the ciphertext. (Argmax selects a model that gives highest probability value out of all models)
...
* [**ACA Reference Statistics**](https://bionsgadgets.appspot.com/gadget_forms/acarefstats.html) - Table of statistics for most of ACA cipher types used in this project, along with description for each statistics
